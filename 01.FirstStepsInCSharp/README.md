...
# 3-та, 4-та и 5-та задачи не са конзолни програми, кодът не е качен
...
# 7.    Напишете C# програма, която прочита от конзолата две числа a и b, пресмята и отпечатва лицето на правоъгълник със страни a и b. 
